...
// Donv's changes 
      $(e).autocomplete({
        source: function( request, response ) {
          ...
          var schoolsHash = {}
          schoolsHash["po"] = $("#school_po").is(':checked');
          schoolsHash["cm"] = $("#school_cm").is(':checked');
          schoolsHash["hm"] = $("#school_hm").is(':checked');
          schoolsHash["sc"] = $("#school_sc").is(':checked');
          schoolsHash["pz"] = $("#school_pz").is(':checked');
          schoolsHash["js"] = $("#school_js").is(':checked');
          for(var k in schoolsHash){
            queryFields[k] = schoolsHash[k];
          }
          $.getJSON( $(e).attr('data-autocomplete'), queryFields, function() {
